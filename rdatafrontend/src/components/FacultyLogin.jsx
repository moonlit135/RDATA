...
const FacultyLogin = () => {
  ...
  const handleLogin = (e) => {
    ...
    // Assuming you have a backend that validates the faculty credentials
    // Here, we check for hardcoded email and password for demo purposes
    if (email === "faculty@tezu.edu.in" && password === "faculty123") {
      alert("Faculty logged in successfully!");
      navigate("/FacultyDashboard"); // Redirect to faculty dashboard after successful login
    } else {
  ...
  return (
    <div className={styles.authWrapper}>
      ...
      <main className={styles.authCard}>
        <h2 className={styles.title}>Faculty Login</h2>
